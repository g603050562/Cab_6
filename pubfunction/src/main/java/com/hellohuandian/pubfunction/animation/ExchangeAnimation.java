...
public class ExchangeAnimation {
    ...
    private LinearLayout info_panel, cost, dialogPanel;
    ...
    public ExchangeAnimation(String hardwareType, LinearLayout info_panel, LinearLayout cost, ImageView black_1, ImageView black_2, FrameLayout up_bar_2_panel, FrameLayout up_bar_1_panel, LinearLayout mDialogPanel, IFExchangeAnimationListener ifExchangeAnimationListener) {
    ...
    public ExchangeAnimation(LinearLayout info_panel, LinearLayout cost, ImageView black_1, ImageView black_2, FrameLayout up_bar_2_panel, FrameLayout up_bar_1_panel, LinearLayout mDialogPanel, IFExchangeAnimationListener ifExchangeAnimationListener) {
        this.info_panel = info_panel;
        this.cost = cost;
        this.black_1 = black_1;
        this.black_2 = black_2;
    ...
    private void An_1() {
        ...
        ObjectAnimator objectAnimator = ObjectAnimator.ofFloat(info_panel, "translationY", -100, height_2 - 60);
        ObjectAnimator objectAnimator_dialog = ObjectAnimator.ofFloat(dialogPanel, "translationY", 0, height_2 + 30);
        ...
        animatorSet.play(objectAnimator).with(objectAnimator_dialog);//两个动画同时开始
        animatorSet.start();
    }
    ...
    private void An_8() {
        AnimatorSet animatorSet = new AnimatorSet();//组合动画
        ObjectAnimator objectAnimator = ObjectAnimator.ofFloat(info_panel, "translationY", height_2 - 60, -100);
        ObjectAnimator objectAnimator_dialog = ObjectAnimator.ofFloat(dialogPanel, "translationY", height_2 + 30, 0);
        objectAnimator.setDuration(time);
