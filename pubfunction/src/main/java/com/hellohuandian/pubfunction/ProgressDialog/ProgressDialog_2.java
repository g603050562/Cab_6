...
public class ProgressDialog_2 {

    private Activity activity;
    private int mtime = -1;
    private AlertDialog dialog;
    private TextView t_1, t_2;
    private Handler handler, speakHandler;
    private View view;

    private Thread thread;
    private int threadStatus = 0;

    public ProgressDialog_2(Activity mActivity, Handler mHandler) {


        this.activity = mActivity;
        this.speakHandler = mHandler;
    ...
    public ProgressDialog_2(Activity mActivity, Handler mHandler , int small) {
