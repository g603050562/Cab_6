...
public class BlackExchangeDialog_9 extends FrameLayout {

    public interface BlackExchangeDialog_9_listener{
        void messageReturn(String msg);
    }
    ...
    public BlackExchangeDialog_9(Context context) {
        super(context);
        this.context = context;
        init();
    }

    public BlackExchangeDialog_9(Context context, @Nullable @org.jetbrains.annotations.Nullable AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        init();
    }

    public BlackExchangeDialog_9(Context context, @Nullable @org.jetbrains.annotations.Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        View view = inflater.inflate(R.layout.activity_main_1080p_black_9_dialog, null);
    ...
    public void showDialog(String info , int time , int type , BlackExchangeDialog_9_listener blackExchangeDialog_9_listener ){
