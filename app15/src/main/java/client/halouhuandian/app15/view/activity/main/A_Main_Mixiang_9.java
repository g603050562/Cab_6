...
import client.halouhuandian.app15.test.TestControl;
 ...
 * 主屏幕 - 前台显示
 */
public class A_Main_Mixiang_9 extends BaseActivity {
    ...
    public BlackExchangeDialog_9 animationDialog;
    //租电池二维码
    ...
    protected void onCreate(@Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_1080p_black_9);
        ...
        initDataService();
        //模块儿测试
//        TestControl.getInstance().batteryUpdate(activity, TestBatteryEnum.dengBoBatteryUpdate);
    }
    ...
    public void setRentBatteryQCode(){
        ...
        rentBarQRcodeView.setImageBitmap(UtilPublic.generateBitmap(dataString_62, 400, 400 , 0xff000000 , 0x00ffffff));
    }
    ...
    public void setDownloadQrCode() {
        downloadQRcodeView.setImageBitmap(UtilPublic.generateBitmap(HttpUrlMap.DownLoadApkJump, 400, 400 , 0xff000000 , 0x00ffffff));
    }
    ...
    public void writeLog(String log) {
        LocalLog.getInstance().writeLog(log , A_Main_Mixiang_9.class);
    }
