package client.halouhuandian.app15.view.customUi.activityAnimation;
 ...
 * 离线换电 动画
 */
public class ExchangeBarAnimation {

    //dialog面板
    private LinearLayout dialogPanelView;
    //扣币面板
    ...
    private IFExchangeAnimationListener ifExchangeAnimationListener;

    public ExchangeBarAnimation(String hardwareType, LinearLayout dialogPanelView, LinearLayout cost, ImageView black_1, ImageView black_2, FrameLayout up_bar_2_panel, FrameLayout up_bar_1_panel, IFExchangeAnimationListener ifExchangeAnimationListener) {
        this.dialogPanelView = dialogPanelView;
        this.cost = cost;
    ...
    public ExchangeBarAnimation(LinearLayout dialogPanelView, LinearLayout cost, ImageView black_1, ImageView black_2, FrameLayout up_bar_2_panel, FrameLayout up_bar_1_panel, IFExchangeAnimationListener ifExchangeAnimationListener) {
        this.dialogPanelView = dialogPanelView;
        this.cost = cost;
        this.black_1 = black_1;
        this.black_2 = black_2;
    ...
    //换电期间 动画
    private void An_1() {
        ObjectAnimator objectAnimator = ObjectAnimator.ofFloat(dialogPanelView, "translationY", 0, height_2);
    ...
    private void An_8() {
        ObjectAnimator objectAnimator = ObjectAnimator.ofFloat(dialogPanelView, "translationY", height_2, 0);
        objectAnimator.setDuration(time);
