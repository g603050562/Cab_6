 ...
 * A_Admin的适配器
 */
public class AdminDcdcBottomAdapter_9 extends BaseAdapter {
    ...
    public AdminDcdcBottomAdapter_9(Context context , AcdcInfoByStateFormat[] acdcStateBeans, AcdcInfoByWarningFormat[] acdcWarningBeans , EnvironmentDataFormat environmentDataFormat) {
        ...
        resources_1 = R.layout.activity_admin_1080p_dcdc_grid_item_2_9;
        resources_2 = R.layout.activity_admin_1080p_dcdc_grid_item_3_9;
    }
    ...
    public View getView(int i, View convertView, ViewGroup viewGroup) {
        ...
        if(i == 1 || i == 0){
            ...
            viewHolder.t_8.setText("HV-" + HV + " SV-" + SV);
            //剩余总功率
            ...
            //环境板版本
            viewHolder.t_10.setText("SV-"+environmentDataFormat.getVersion()+"HV-"+environmentDataFormat.getFunctionState());
        }
        return convertView;
    }
