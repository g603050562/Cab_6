 ...
 * Description:
 */
public class HttpOptDcdcList extends Thread {

    private String cab_id;
    Consumer ifHttpGetTelLinstener;

    /**
     * @param cab_id                电柜编号（例：04531）
     * @param ifHttpGetTelLinstener 接口
     */
    public HttpOptDcdcList(String cab_id, Consumer<String> ifHttpGetTelLinstener) {
        this.cab_id = cab_id;
    ...
    public void run() {
        super.run();
        String path = MyApplication.apc + "Dcdc/uplists.html";
...
//                String sin = jsonObject.toString();
//
