...
public class UpdataPdu {

    private Activity activity;
    private String versionUrl;
    private String versionName;
    private String saveName = "pdu_update.bin";
    private Handler renturnHandler;

    public UpdataPdu(Activity activity, String versionUrl, String versionName, Handler renturnHandler) {
