 ...
 * 获取后台400电话
 */
public class HttpGetTel extends Thread {
     ...
     */
    public HttpGetTel(String cab_id, IFHttpGetTelLinstener ifHttpGetTelLinstener) {
        this.cab_id = cab_id;
    ...
    public void run() {
        super.run();
        String path = MyApplication.app + "Service/getContact.html";
        ...
        try {
            ...
            if (httpResponse.getStatusLine().getStatusCode() == HttpStatus.SC_OK) {
                ...
                returnMessgae("-1", "服务器错误：HttpGetTel" + httpResponse.getStatusLine().getStatusCode(),"");
            }
        } catch (Exception e) {
            returnMessgae("-1", "json解析错误：HttpGetTel"+e.toString(),"");
        }
    }

    private void returnMessgae(String code, String str, String data) {
        if (ifHttpGetTelLinstener != null)
            ifHttpGetTelLinstener.onHttpGetTelResult(code,str,data);
    }
}
