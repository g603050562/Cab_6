...
public class HttpOutLineCheckUserBalance extends Thread {
    ...
    public void run() {
        ...
        LogUtil.I("网络：   HttpOutLineCheckUserBalance   电池 - " + in_battery);
        ...
        String path = MyApplication.apc + "Check/checkUserBalance.html";
        ...
        try {
            ...
            if (httpResponse.getStatusLine().getStatusCode() == HttpStatus.SC_OK) {
                ...
                LogUtil.I("网络：   JSON：HttpOutLineCheckUserBalance" + httpResponse.getStatusLine().getStatusCode());
            }
        } catch (Exception e) {
            returnMessgae("-1", "网络：JSON：HttpOutLineCheckUserBalance" + e.toString(), "");
            LogUtil.I("网络：   JSON：HttpOutLineCheckUserBalance" + e.toString());
        }
    }
